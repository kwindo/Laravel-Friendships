...
//            'created_at' => Carbon::now(),
    ...
    public static function getFullModelName($modelClassName)
    {
        ...
        $namespace = config('friendships.model_namespace', 'App');
    ...
    /* public static function getUserModelName()
    {
        return Interaction::getFullModelName(
            config(
                'friendships.user_model_class_name',
                config('friendships.models.user', 'User')
            )
        );
    } */
    ...
    /* public static function getInteractionRelationModelName()
    {
        return Interaction::getFullModelName(
            config(
                'friendships.models.interaction_relation',
                \Kimdevylder\Friendships\Models\InteractionRelation::class
            )
        );
    } */
    ...
    public static function getFriendshipModelName()
    {
        return Interaction::getFullModelName(
            config(
                ...
                \Kimdevylder\Friendships\Models\Friendship::class
            )
        );
    }
    ...
    /* public static function getFriendshipGroupsModelName()
    {
        return Interaction::getFullModelName(
            config(
                'friendships.models.friendship_groups',
                \Kimdevylder\Friendships\Models\FriendshipGroups::class
            )
        );
    } */
}
